<div id="shopping-cart">
    ...
    if (!isset(Yii::app()->session['shopping_list'])) {
        ...
        <div class="cart-buttons">
            ...
            <div class=""><?php echo CHtml::link('Inquiry <i class="icon-chevron-right icon-white"></i>', Yii::app()->createAbsoluteUrl('inquiry'), array('id' => 'button', 'class' => 'btn btn-success'));  ?></div>
        </div>
