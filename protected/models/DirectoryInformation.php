...
class DirectoryInformation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_id, first_name, middle_name, last_name, job_title, image, email, phone, fax, zip_code, address, area, province, country, status, trash, created_at, modified_at, trashed_at', 'required'),
