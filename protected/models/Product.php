...
class Product extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_id, name, slug, sku, category_id, custom_category_id, description, price, price_type, minimum_quantitiy, stock, status, trash, created_at, modified_at, trashed_at', 'required'),
			array('company_id, category_id, custom_category_id, minimum_quantitiy, stock, status, trash', 'numerical', 'integerOnly'=>true),
