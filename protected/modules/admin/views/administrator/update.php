...
$this->breadcrumbs=array(
	...
	$model->administrator_id=>array('view','id'=>$model->administrator_id),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View Administrator', 'url'=>array('view', 'id'=>$model->administrator_id)),
	array('label'=>'Manage Administrator', 'url'=>array('admin')),
);
?>

<h1>Update Administrator <?php echo $model->administrator_id; ?></h1>
