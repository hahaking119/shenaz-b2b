...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('custom_category_id')); ?>:</b>
	<?php echo CHtml::encode($data->custom_category_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('minimum_quantitiy')); ?>:</b>
	<?php echo CHtml::encode($data->minimum_quantitiy); ?>
	<br />
